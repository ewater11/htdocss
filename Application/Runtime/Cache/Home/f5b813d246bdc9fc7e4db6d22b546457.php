...
<body><!--导航条-->
  <nav class="navbar navbar-default">
   <div class="container-fluid">
     ...
     <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
       ...
       <form action="<?php echo U('Jg/indexedit');?>" method="get" class="navbar-form navbar-left">
 ...
 <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  ...
  <ul class="nav navbar-nav navbar-right">
     <li><a href="<?php echo U('Jg/indexedit');?>" >编辑</a></li>
     <li class="dropdown">
...
<table width="900" border="0" cellpadding="0" cellspacing="1"  align="center" class="table table-bordered" id="g_table">
 ...
 <tr align="center" >
        ...
        <td width="7%"  bgcolor="#CCCCCC" class="pu"><a href="<?php echo U('Jg/index');?>" class="btn btn-info btn-sm">返回</a></td>
        <td width="5%"  bgcolor="#CCCCCC" class="pu"></td>
                      </tr>
 

                      <?php if(is_array($select)): $i = 0; $__LIST__ = $select;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$jg): $mod = ($i % 2 );++$i;?><td > </td>                       
	...
	<td  ><span onclick="editInfo(this)" id="editInfo" class="btn btn-primary btn-xs active">修改</span>
   </td>
   <td ><span onclick="del(this)" id="del" class="btn btn-danger btn-xs active">删除</span></td>
  ...
  <div class="modal-dialog" role="document">  
      <div class="modal-content">  
          ...
          <div class="modal-body modal-li">  
             <form action="<?php echo U('Jg/edit');?>" method="post" id="form2">  
               <table >
                        <tr>
                       <td>
                              <div class="input-group">
                       ...
                       <div class="input-group">
                            <span class="input-group-addon" id="basic-addon1">铂</span>
                            <input name="pt" size="20" type="text" class="form-control " id="pt1" placeholder="请输入铂价格" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')">  
         </div>
                         </td>
                       </tr>
                     <tr>
                     ...
                     <tr>
                       ...
                       <td><div class="input-group">
                                      <span class="input-group-addon" id="basic-addon1">1#银</span>
                                      <input size="17.5" name="silver" class="form-control " type="text" id="silver11" size="15" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')">
         </div>
                                     </td>
                       </tr>
                     <tr>
                       <td ><div class="input-group">
                                      <span class="input-group-addon" id="basic-addon1">2#银</span>
                                      <input size="17.5" name="silver1" class="form-control " type="text" id="silver12" size="15" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')">
         </div>
                                      </td>
                       <td >
                                     <div class="input-group">
  ...
  <div class="modal-dialog" role="document">  
      <div class="modal-content">  
          <div class="modal-header">  
             ...
             <h4 class="modal-title" id="myModalLabel">价格删除</h4>  
          </div>  
          <div class="modal-body modal-li">  
             <form action="<?php echo U('Jg/del');?>" method="post" id="form2">  
               <table >
                        <tr>
                       <td>
                              <div class="input-group">
                                      <span class="input-group-addon" id="basic-addon1">日期</span>
                                      <input name="riq" size="18" type="date" class="form-control " id="riq2" readonly> 
                              </div>
                      </td>
                       <td>
                       <div class="input-group">
                            <span class="input-group-addon" id="basic-addon1">铂</span>
                            <input name="pt" size="20" type="text" class="form-control " id="pt2" readonly>  
         </div>
                         </td>
                       </tr>
                     <tr>
                       ...
                       <div class="input-group">
                                      <span class="input-group-addon" id="basic-addon1">钯</span>
                                      <input size="20" name="pd" class="form-control "  size="15" id="pd2" readonly>
                         </div> 
                         </td>
                       <td>
                        <div class="input-group">
                                      <span class="input-group-addon" id="basic-addon1">铑</span>
                                      <input size="20" name="rh" class="form-control " size="15" id="rh2" readonly>
         </div>
         </td>  
                </tr> 
                        <tr>    <td >
                       <div class="input-group">
                                      <span class="input-group-addon" id="basic-addon1">铱</span>
                                      <input size="20" name="yr" class="form-control " type="text" size="15" id="yr2" readonly>
         </div></td>
                       <td >
                       <div class="input-group" >
                                      <span class="input-group-addon" id="basic-addon1">钌</span>
                                      <input size="20" size="20"  name="ru" class="form-control " type="text" size="15" id="ru2" readonly>
         </div>
                         </td>
                     </tr>
                     <tr>
                       <td >
                        <div class="input-group">
                                      <span class="input-group-addon" id="basic-addon1">金</span>
                                     <input size="20" name="gold" class="form-control " type="text" id="gold2" size="15" readonly> 
                                      </td>
                       <td><div class="input-group">
                                      <span class="input-group-addon" id="basic-addon1">1#银</span>
                                      <input size="17.5" name="silver" class="form-control " type="text" id="silver21" size="15" readonly>
         </div>
                                     </td>
                       </tr>
                     <tr>
                       <td ><div class="input-group">
                                      <span class="input-group-addon" id="basic-addon1">2#银</span>
                                      <input size="17.5" name="silver1" class="form-control " type="text" id="silver22" size="15" readonly>
         </div>
                                      </td>
                       <td >
                                     <div class="input-group">
                                      <span class="input-group-addon" id="basic-addon1">金川铂</span>
                                      <input size="16" name="jcpt" class="form-control " type="text" id="jcpt2" size="15" readonly>
         </div>
                    </td>
                     </tr>
                     <tr>
                       ...
                       <div class="input-group" item-width="100%">
                                      <span class="input-group-addon" id="basic-addon1">金川钯</span>
                                       <input size="16" name="jcpd" class="form-control " type="text" id="jcpd2" size="15" readonly>
         </div>
                      </td>
                       <td > <input size="16" name="id" type="hidden"  id="id2" size="15" ></td>
                      
                     </tr>
                     
                     <tr>
                          <td colspan="4" align="center" ><input  class="btn btn-primary" type="Submit" name="Submit"  value="删除"/> <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>  　</td>
                        </tr>
                 </table>
             </form>  
         </div>  
...
function del(obj){
  ...
  var tds= $(obj).parent().parent().find('td'); 
        var id2 = $(obj).parent().prev().prev().val();
       $('#riq2').val(tds.eq(1).text());  
       $('#gold2').val(tds.eq(2).text());  
       $('#silver21').val(tds.eq(3).text()); 
       $('#silver22').val(tds.eq(4).text());
        $('#pt2').val(tds.eq(5).text()); 
        $('#jcpt2').val(tds.eq(6).text()); 
        $('#ru2').val(tds.eq(7).text()); 
        $('#rh2').val(tds.eq(8).text()); 
        $('#pd2').val(tds.eq(9).text()); 
        $('#jcpd2').val(tds.eq(10).text()); 
        $('#yr2').val(tds.eq(11).text()); 
        $('#id2').val(id2);
        $('#modal2').modal('show'); 
...
function editInfo(obj) {    
        var tds= $(obj).parent().parent().find('td'); 
        var id1 = $(obj).parent().prev().val();
       $('#riq1').val(tds.eq(1).text());  
       $('#gold1').val(tds.eq(2).text());  
       $('#silver11').val(tds.eq(3).text()); 
       $('#silver12').val(tds.eq(4).text());
