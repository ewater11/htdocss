...
<!--end导航条-->
  <div class="table-responsive">
    <table   align="center" class="table  table-hover" id="g_table">
      <tr align="center">
        <td width="15%" bgcolor="#CCCCCC" class="pu">客户名称</td>
        <td width="7%" bgcolor="#CCCCCC" class="pu">手机</td>
        <td width="7%" bgcolor="#CCCCCC" class="pu">联系人</td>
        <td width="6%" bgcolor="#CCCCCC" class="pu">电话</td>
        <td width="7%" bgcolor="#CCCCCC" class="pu">收货地区</td>
        <td width="5%" bgcolor="#CCCCCC" class="pu"><a href="<?php echo U('Kh/index');?>" class="btn btn-info btn-sm">返回</a></td>
      </tr>
